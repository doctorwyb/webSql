...
import com.doctor.model.JobLogs;
import com.doctor.model.TimingVo;
import com.doctor.service.TimingService;
import com.doctor.util.ScheduleUtils;
import com.doctor.util.SpringContextHolder;
    ...
    void initTask(){
        ...
        new Thread(() -> {
            for (TimingVo timingVo : initList) {
                ...
                job.setClassName("com.doctor.db.JobExecuteFactory");
